...
{
	$query = mysqli_query($conn,"SELECT sum(total_cases) AS jumlah FROM tb_penderita WHERE id_country='$bulan'");
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(total_deaths) AS jumlah FROM tb_penderita WHERE id_country='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(total_recovered) AS jumlah FROM tb_penderita WHERE id_country='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(active_cases) AS jumlah FROM tb_penderita WHERE id_country='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(total_tests) AS jumlah FROM tb_penderita WHERE id_country='$bulan'");
	$row = $query->fetch_array();
