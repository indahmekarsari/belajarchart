...
$india = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='India'");
$korsel = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Korea Selatan'");
$turkey = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Turkey'");
$vietnam = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Vietnam'");
$japan = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Japan'");
$iran = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Iran'");
$indo = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Indonesia'");
$malay = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Malaysia'");
$thai = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Thailand'");
$israel = mysqli_query($conn, "SELECT * FROM tb_penderita WHERE country='Israel'");
?>
...
var data = {
    labels: ["Total Cases","Total Deaths","Total Recovery","Active Recovored","Total Tests"],
            datasets: [
                {
                    label: "India",
                    fill: false,
                ...
                },
                {
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($thai)) { echo '"' . $p['total_cases'] . '","' . $p['total_deaths'] . '","' . $p['total_recovered'] . '","' . $p['active_cases'] . '","' . $p['total_tests'] . '",';}?>]
                },
                {
                    label: "Israel",
                    fill: false,
